...
public class CGameModeCommand {
    ...
    public static void register(CommandDispatcher<FabricClientCommandSource> dispatcher) {
        dispatcher.register(literal("cgamemode")
                ...
                .then(literal("list")
                        .then(argument("gameMode", new CEnumArgumentType<>(StringRepresentable.fromEnum(GameType.class::getEnumConstants), GameType.class::getEnumConstants))
                                .executes(ctx -> listWithGameMode(ctx.getSource(),ctx.getArgument("gameMode", GameType.class))))));
    }
