...
public class FakeCommandSource extends ServerCommandSource {
    public FakeCommandSource(ClientPlayerEntity player) {
        super(player, player.getPos(), player.getRotationClient(), null, 314159265, player.getEntityNameddddddddddddddddddddddddddddddddddddddddddd(), player.getName(), null, player);
    }
